...
class Controller extends React.Component {
    ...
    initialFoods() {
        const list = lists.filter(food => food.category === category.trangmieng);
        return list;
    }
    ...
    setFoodsByCategory(category) {
        ...
        const list = lists.filter(food => food.category === category);
        this.setState({category: category, foods: list});
    }
    ...
    render() { 
        return (
            <div>
                ...
                {/* Content */}
                <Content foods={this.state.foods} category={this.state.category} window={this.state.window}/>
                {/* Footer */}
