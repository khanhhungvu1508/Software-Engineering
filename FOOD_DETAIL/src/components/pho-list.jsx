            ...
            <div id="food-list">
                <Grid container spacing={3} id="block-list">           
                    <Grid item sm={6}>
                        <Paper>
                            <div id="content-name-food">
                                <Button id="btn-list-food" onClick = {() => this.setFoodClick("https://image-us.eva.vn/upload/2-2019/images/2019-06-28/1561709538-885-thumbnail_schema_article.jpg", "Phở bò", 35000)}>
                                ...
                                <div id="price-buy-food">
                                    35.000 VND
                                    <Button id="buy-button" onClick = {() => this.setFoodClick("https://image-us.eva.vn/upload/2-2019/images/2019-06-28/1561709538-885-thumbnail_schema_article.jpg", "Phở bò", 35000)}>
                                        <FiShoppingCart />
                                    </Button>
                                </div>
                                <div id="space-box"></div>
                    ...
                    <Grid item sm={6}>
                        <Paper>
                            <div id="content-name-food">
                                <Button id="btn-list-food" onClick = {() => this.setFoodClick("https://image-us.eva.vn/upload/4-2020/images/2020-12-11/image3-1607656518-418-width512height272.png", "Phở gà", 35000)}>
